...
<body>
    ...
    */    
    if((isset($_GET['age']))AND(isset($_GET['gender']))){
        ...
        if($age<12){
            echo"Hello $adj Kiddo !";
        }else if(($age>11)AND($age<19)){
            echo"Hello $adj Teenager !";
        }else if(($age>18)AND($age<116)){
            echo"Hello $adj Adult !";
        }else{
   ...
   <form action="" method="get">
       How old are you : <input type="text" name="age" id="age" size=3 maxlength="3">
       what is gender ? <input type="radio" name="gender" value="male">male <input type="radio" name="gender" value="female">female
